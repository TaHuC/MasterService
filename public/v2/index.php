                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            ...
                            $client->findPagination("orders", $range, $perpage);

                            ?>
                                <nav aria-label="Page navigation" class="pagination navbar-right">
                                    <ul class="pagination">
                                        ...
                                        if($client && count($client) > 0){
                                            ...
                                            if($number <= 1){
                                                ?>
                                                <li><a href="#" disabled="on" aria-label="Previos"><span aria-hidden="true">&laquo;</span></a></li>
                                                <li><a href="?page=<?php echo $next; ?>"><span aria-hidden="true">&raquo;</span></a></li>
                                                <?php
                                                # last page
                                            } elseif($number >= $pages) {

                                                ?>
                                                <li><a href="?page=<?php echo $prev; ?>" disabled="on" aria-label="Previos"><span aria-hidden="true">&laquo;</span></a></li>
                        ...
                        <div class="x_content" id="thisTable" style="overflow-y: auto;">
                            <table id="example indexTable" class="table table-striped responsive-utilities jambo_table">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                        $x = 0;
                                    foreach ($client->dataPagination() as $all){
                                        $x++;
                                        ?>
