...
@section('content')
    ...
    <div class="container-fluid">
        <div class="jumbotron">
            <div class="row">
                <div class="col-6">
                    <h4 class="title">{{ $product->brand->title }} {{ $product->model->title }} <span class="badge badge-primary">{{ $product->orders->last()->status->status }}</span></h4>
                ...
                <div class="col-6 bg-dark mb-3 text-white">
                    @if($product->orders->last()->statusId === 4 || count($product->orders) === 0)
