                    ...
                    <h4 class="title">Add Client</h4>
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('client.store') }}">
                            ...
                            <div class="input-field col s12 {{ $errors->has('name') ? ' has-error' : '' }}">
                                ...
                                <input id="name" type="text" autocomplete="off" class="validate" name="name" value="{{ old('name') }}" required autofocus>
                            ...
                            <div class="input-field col s12 {{ $errors->has('email') ? ' has-error' : '' }}">
                                <input id="email" type="email" autocomplete="off" class="validate" name="email" value="{{ old('email') }}">
                            ...
                            <div class="input-field col s12 {{ $errors->has('phone') ? ' has-error' : '' }}">
                                <input id="phone" type="text" autocomplete="off" class="validate" name="phone" value="{{ old('phone') }}" required>
